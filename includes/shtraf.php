				...
				<div class="col-md-12">
					<div class="inner">
						...
						<div class="btn-wrap">
							...
							<div class="half">
								<button id="jsfood5" class="shtraf__btn shtraf__btn--black shtraf__btn--eat" myfood="5" ><span>Не хочу готовить и отвлекаться</span><i>полноценное <b>5-разовое</b> питание на весь день</i></button>
					...
					<div class="inner">
						...
						<div class="end clearfix">
							<div class="col-md-offset-1 col-md-2 end__item">
								...
								<span class="kkal jsitogo">3472</span>
...
<!-- =====================mobileversion========================= -->
	...
	<div class="form-order jsmob" id="jsmobversion2">
			...
			<div class="info clearfix">
				...
				<div class="price">
					<span class="jspricemobile">Цена: <i>7 400</i>руб.</span>
					<span class="jspricemobinday"><b>1 172</b>руб./день</span>
				</div>
