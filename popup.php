...
<br><br>
<a href="#log-in-1" name="modal">Оставьте заявку</a><br><br>	
<a href="#log-in-2" name="modal">Заказать комплект питания</a><br><br>
		...
		<div class="dd-tarif-form">
			...
			<form class="form1" action="#" method="post">
				...
				<div class="dd-form_input table_left">
					<label>
						<input class="dd-input" type="text" placeholder="Введите ваш телефон">
